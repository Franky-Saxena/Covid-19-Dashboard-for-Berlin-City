...
def run():
    ...
    link = '[©Developed by Franky Saxena](https://www.linkedin.com/in/franky-saxena-371ab5173/)'
...
st.write('''
    Dashboard created by [Franky Saxena](https://www.linkedin.com/in/franky-saxena-371ab5173/), with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/Franky-Saxena).
